...
if ($return === null) {
    ...
    SELECT ?method ?script ?description ?name ?script_example
    WHERE {?method rdf:type csharp:Methods . ?method csharp:hasSyntax ?script . ?method csharp:Description ?description . ?method csharp:Name ?name . ?script csharp:script ?script_example}
END;
} else {
    $sparql = <<< END
    PREFIX csharp: <http://www.semanticweb.org/user/ontologies/2019/10/untitled-ontology-3#>
    PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
    SELECT ?method ?script ?description ?name ?script_example
    WHERE {?method rdf:type csharp:Methods . ?method csharp:hasSyntax ?script . ?method csharp:Description ?description . ?method csharp:Name ?name . ?script csharp:script ?script_example . FILTER regex(?name, "${return}")}
END;
}
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        <form action="listMethod.php" method="post">
                            <br>
