...
if ($return === null) {
    ...
    SELECT ?value ?script ?description ?name ?script_example
    WHERE {?value rdf:type csharp:ValueType . ?value csharp:hasSyntax ?script . ?value csharp:Description ?description . ?value csharp:Name ?name . ?script csharp:script ?script_example}
END;
} else {
    $sparql = <<< END
    PREFIX csharp: <http://www.semanticweb.org/user/ontologies/2019/10/untitled-ontology-3#>
    PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
    SELECT ?value ?script ?description ?name ?script_example
    WHERE {?value rdf:type csharp:ValueType . ?value csharp:hasSyntax ?script . ?value csharp:Description ?description . ?value csharp:Name ?name . ?script csharp:script ?script_example . FILTER regex(?name, "${return}")}
END;
}
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        <form action="listValue.php" method="post">
                            <br>
