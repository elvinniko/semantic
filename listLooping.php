...
if ($return === null) {
    ...
    SELECT ?loop ?script ?description ?name ?script_example
    WHERE {?loop rdf:type csharp:Loop . ?loop csharp:hasSyntax ?script . ?loop csharp:Description ?description . ?loop csharp:Name ?name . ?script csharp:script ?script_example }
END;
} else {
    $sparql = <<< END
    PREFIX csharp: <http://www.semanticweb.org/user/ontologies/2019/10/untitled-ontology-3#>
    PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
    SELECT ?loop ?script ?description ?name ?script_example
    WHERE {?loop rdf:type csharp:Loop . ?loop csharp:hasSyntax ?script . ?loop csharp:Description ?description . ?loop csharp:Name ?name . ?script csharp:script ?script_example . FILTER regex(?name, "${return}") }
END;
}
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        <form action="listLooping.php" method="post">
                            <br>
