...
SELECT ?programming_language ?person ?name ?description
WHERE {?programming_language rdf:type csharp:ProgrammingLanguage . ?programming_language csharp:foundBy ?person . ?person csharp:Name ?name . ?person csharp:Description ?description}
END;
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" style="font-size:27px" href="#">History Of C#</a>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><b>INVENTOR</b></h3>
                            </div>
                            <div class="card-body">
